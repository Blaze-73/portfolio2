...
`
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(props: any) {
        ...
        const mat = this.mouse.material
        if (!mat || Array.isArray(mat)) return
        const matUniforms = (mat as THREE.RawShaderMaterial).uniforms
        matUniforms.force.value.set(forceX, forceY)
        matUniforms.center.value.set(centerX, centerY)
        matUniforms.scale.value.set(props.cursor_size, props.cursor_size)
        super.update()
      }
    }
